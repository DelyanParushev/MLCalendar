  ...
  return (
    <div className="min-h-screen transition-colors duration-200 ease-in-out bg-[color:var(--md-sys-color-surface)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <header className="flex justify-between items-center mb-4 sm:mb-6 lg:mb-8 relative">
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3 text-[color:var(--md-sys-color-on-surface-variant)]">
              <span className="material-icons text-xl sm:text-2xl lg:text-3xl text-[color:var(--md-sys-color-primary)]">calendar_today</span>
              <h1 className="text-xl sm:text-2xl lg:text-4xl font-medium transition-colors duration-200">Caltivity</h1>
            </div>
          </div>
        ...
        <div className="space-y-8">
          {viewMode === 'standard' && (
            <>
              {/* Standard View - Show AddEventForm at top */}
